...
const inputUI = {
  ...
  color: {
    white: {
      outline:
        "shadow-sm bg-white dark:bg-gray-900 text-gray-900 dark:text-white ring-1 ring-inset ring-gray-300 dark:ring-gray-700 focus:ring-1 focus:ring-curious-blue dark:focus:ring-primary-400",
    },
  },
};
</script>
...
<template>
  <div class="relative bg-transparent z-10 my-[4px]">
    <div class="lg:absolute lg:inset-0 lg:left-1/2">
      <NuxtImg
        class="h-64 w-full bg-gray-50 object-cover sm:h-80 lg:absolute lg:h-full rounded shadow-sm"
    ...
    <div class="pb-24 pt-16 sm:pb-32 sm:pt-24 lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-2 lg:pt-32">
      <div class="px-6 lg:px-8">
        <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
          <h2 class="text-3xl font-bold tracking-tight font-montserrat text-tropaz-blue">Formulario de Consulta</h2>
          <p class="mt-2 text-lg leading-8 text-gray-600 font-montserrat">
            Por favor complete el siguiente formulario para reservar su cita.
          </p>
          <form action="#" method="POST" class="mt-16 pointer-events-auto">
            <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
              <div>
                <label for="first-name" class="block text-sm font-semibold leading-6 text-gray-900">Nombre:*</label>
                <div class="mt-2">
                  <UInput size="lg" name="first-name" id="first-name" autocomplete="given-name" :ui="inputUI" />
                </div>
              </div>
              <div>
                <label for="last-name" class="block text-sm font-semibold leading-6 text-gray-900">Apellidos:*</label>
                <div class="mt-2">
                  <UInput size="lg" name="last-name" id="last-name" autocomplete="family-name" :ui="inputUI" />
                </div>
              </div>
              <div class="sm:col-span-2">
                <label for="email" class="block text-sm font-semibold leading-6 text-gray-900">Email:*</label>
                <div class="mt-2">
                  <UInput size="lg" name="email" id="email" autocomplete="email" :ui="inputUI" />
                </div>
              </div>
              <div class="sm:col-span-2">
              ...
              <div class="sm:col-span-2">
                ...
                <div class="mt-2">
                  <UInput size="lg" name="subject" id="subject" autocomplete="subject" :ui="inputUI" />
                </div>
              </div>
              <div class="sm:col-span-2">
                <div class="flex justify-between text-sm leading-6">
...
label {
  @apply font-maven text-tropaz-blue font-semibold text-[16px];
}
</style>
